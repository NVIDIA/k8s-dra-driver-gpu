...
Refer to [Architecture](architecture.md) for how requests are fulfilled.
...
- [Install and validate](get-started.md)

## Learn more

- [Architecture](architecture.md) — components, request flows, and reference links.
