...
replace k8s.io/dynamic-resource-allocation => github.com/everpeace/kubernetes/staging/src/k8s.io/dynamic-resource-allocation v0.0.0-20250630115913-d28791fa625a
